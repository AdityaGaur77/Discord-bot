...
FEATURE_CATEGORIES = {
    ...
    "scouting": {
        "name": "Match Scouting",
        "description": "Compare scouted teams head-to-head",
        "color": 0x43A047,
        "commands": [
            ("`/scout compare <a> <b>`", "Compare two teams' scouting averages"),
        ],
    },
    "meetings": {
        "name": "Meetings",
        "description": "Log and track team meetings",
        "color": 0x1565C0,
        "commands": [
            ("`/meeting start`",          "Open a new meeting log"),
            ("`/meeting end [notes]`",    "Close the meeting and record notes"),
            ("`/meeting summary`",        "View recent meeting summaries"),
        ],
    },
    "admin": {
        "name": "Server Setup",
...
class HelpCog(commands.Cog):
    ...
    @app_commands.choices(category=[
        ...
        app_commands.Choice(name="Meetings",               value="meetings"),
        ...
        if category == "competition":
            ...
            embed.add_field(
                ...
                value=(
                    ...
                    "no public shaming. The filter applies to everyone, including admins."
                ),
                inline=False,
            )
